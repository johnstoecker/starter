...
Ext.define("starter.controller.Application", {
	requires: ['starter.view.NewPatient', 'starter.store.Doctors'],
	...
	addPatient: function() {
		if(!this.newPatient){
			this.newPatient = Ext.create('starter.view.NewPatient');
	...
	showPatients: function() {
		if(!this.patientView){ 
			this.patientView = Ext.create('starter.view.PatientView');
		}
	...
	showDoctors: function() {
		if(!this.doctorView){ 
			this.doctorView = Ext.create('starter.view.DoctorView');
		}
	...
	showSort: function(){
		if(!this.sortView){
			this.sortView = Ext.create('starter.view.Sort');
